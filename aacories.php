...
<html dir="rtl">
	...
	<body class="is-preload">
							...
							<section id="two" class="spotlights">
								<section>
									<a href="generic.php" class="image">
										<img src="images/a.jpg" alt="" data-position="center center" />
									</a>
									<div class="content">
										<div class="inner">
											<header class="major">
											...
											<h4>  وحلوا اساور من فضة</h4>
											<ul class="actions">
												<li><a href="https://instagram.com/lazord.hilia?igshid=MzRlODBiNWFlZA==" class="button">حساب الانستجرام</a></li>
	 ...
	 <button type="submit"  name="add" onclick="add()">إضافة التعليق</button>
								...
								<section>
									<a href="generic.php" class="image">
										<img src="images/k.jpg" alt="" data-position="top center" />
									</a>
									<div class="content">
										<div class="inner">
											<header class="major">
											...
											<h4>  ذهب </h4>
											<ul class="actions">
												<li><a href="https://instagram.com/golden_ring.korea?igshid=MzRlODBiNWFlZA==" class="button">حساب الانستجرام</a></li>
												<form action="comments.php" method="post">
	 <button type="submit"  name="add" onclick="add()">إضافة التعليق</button>
								</form>
											</ul>
...
<section id="two" class="spotlights">
								<section>
									<a href="generic.php" class="image">
										<img src="images/acci.jpeg" alt="" data-position="center center" />
									</a>
									<div class="content">
										<div class="inner">
											<header class="major">
												<h2>اكسسوارات وهدايا</h2>
											</header>
											<h4> اكسسوارات هاند مايد</h4>
											<ul class="actions">
												<li><a href="https://instagram.com/r_of_accessories?igshid=MzRlODBiNWFlZA==" class="button">حساب الانستجرام</a></li>
												<form action="comments.php" method="post">
	 <button type="submit"  name="add" onclick="add()">إضافة التعليق</button>
								</form>
											</ul>
